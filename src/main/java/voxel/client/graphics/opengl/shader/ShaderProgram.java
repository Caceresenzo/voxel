...
import voxel.client.graphics.opengl.shader.variable.attribute.IntegerAttribute;
import voxel.client.graphics.opengl.shader.variable.uniform.BooleanUniform;
import voxel.client.graphics.opengl.shader.variable.uniform.FloatUniform;
